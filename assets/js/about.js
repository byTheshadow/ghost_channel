...
function generateCodeMatrix() {
    const columns = Math.floor(window.innerWidth / 42);
    ...
    for (let i = 0; i < columns * rows; i++) {
        ...
        char.textContent = codeSnippets[Math.floor(Math.random() * codeSnippets.length)].substring(0, 3);
